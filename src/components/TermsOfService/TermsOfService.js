...
const TermsOfService = props => {
  ...
  return (
    <div className={classes}>
      <p className={css.lastUpdated}>Last updated: August 14, 2021</p>
...
You agree that the original English text shall prevail in the case of a dispute.</p>
      ...
      <ul>
        ...
        <li>
          <p>By visiting this page on our website: <ExternalLink href="https://www.fromthepeople.co/contact" rel="external nofollow noopener" target="_blank">https://www.fromthepeople.co/contact</ExternalLink></p>
        </li>
      </ul>
    </div>
  );
